...
if __name__ == "__main__":
    ...
    rfps = np.greater_equal(rfps, np.tile(np.amax(rfps, axis=1).reshape(n_success, 1), (1, 110))).astype(int) # TODO: consider multiple reference points
    preds_labels = np.concatenate((blds, flrs, rfps), axis=1)
    n_loc_failure = 0
    sum_pos_err = 0.0

...
# -*- coding: utf-8 -*-
##
# @file     bf_weighted-multi-label_classification.py
# @author   Kyeong Soo (Joseph) Kim <kyeongsoo.kim@gmail.com>
# @date     2017-12-01
#
# @brief    Build and evaluate a deep-learning-based buidling-floor
#           weighted-multi-label classification system using Wi-Fi fingerprinting
#
...
if __name__ == "__main__":
    ...
    # }
    ### weighted cost function for multi-label classification
    # class WeightedBinaryCrossEntropy(object):

    #     def __init__(self, weights):
    #         self.weights = weights  # tensor with the same shape as 'output'
    ...
    f.write("  - Classifier loss weight for buildings: %.2f\n" % building_weight)
    f.write("  - Classifier loss weight for floors: %.2f\n" % floor_weight)
    f.write("* Performance\n")
    # f.write("  - Loss = %e\n" % loss)
